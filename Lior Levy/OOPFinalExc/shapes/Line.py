...
class Line(AbsShapes):
    ...
    def translate(self, points):
        self.firstPoint = (points[0] + self.firstPoint[0], points[1] + self.firstPoint[1])
        self.secondPoint = (points[0] + self.secondPoint[0] , points[1] + self.secondPoint[1])

    def draw(self , canvas ):
        cv2.line(canvas, self.firstPoint, self.secondPoint, self.color, self.thickness)