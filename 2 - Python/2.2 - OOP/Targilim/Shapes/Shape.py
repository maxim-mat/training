...
class Shape(metaclass=abc.ABCMeta):
    def __init__(self):
        self.sub_shapes = []  # Initialize the sub-shapes list

    def add_shape(self, sub_shape):
        """
        Adds a sub-shape to the current shape.
        :param sub_shape: The sub-shape to add
        """
        self.sub_shapes.append(sub_shape)
